...
CREATE TABLE jadwal_lab (
    ...
    hari INT(1) NULL, -- 1=Senin s/d 7=Minggu
...
-- 1. Izinkan id_profil NULL di jadwal_asisten (Untuk Jadwal Umum)
ALTER TABLE jadwal_asisten MODIFY COLUMN id_profil INT NULL;

-- 2. Tambah kolom pendukung perulangan di JADWAL ASISTEN
ALTER TABLE jadwal_asisten
ADD COLUMN tanggal_selesai DATE NULL AFTER tanggal,
ADD COLUMN model_perulangan ENUM('sekali', 'mingguan', 'rentang') DEFAULT 'sekali' AFTER tanggal_selesai;

-- 3. Tambah kolom pendukung perulangan di JADWAL PIKET
ALTER TABLE jadwal_piket
ADD COLUMN tanggal_selesai DATE NULL AFTER tanggal,
ADD COLUMN model_perulangan ENUM('sekali', 'mingguan', 'rentang') DEFAULT 'sekali' AFTER tanggal_selesai;

-- 4. Tambah kolom pendukung perulangan di JADWAL KULIAH
ALTER TABLE jadwal_kuliah
ADD COLUMN tanggal_selesai DATE NULL AFTER tanggal,
ADD COLUMN model_perulangan ENUM('sekali', 'mingguan', 'rentang') DEFAULT 'sekali' AFTER tanggal_selesai;

ALTER TABLE jadwal_piket
ADD COLUMN jam_mulai TIME NULL,
ADD COLUMN jam_selesai TIME NULL;
