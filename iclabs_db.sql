...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 30, 2026 at 03:38 PM
...
(4, NULL, 3, NULL, NULL, NULL, '2026-01-29 07:28:41'),
(5, 3, NULL, NULL, NULL, NULL, '2026-01-29 07:32:37'),
(6, NULL, 4, NULL, NULL, NULL, '2026-01-29 08:01:15'),
(7, 4, NULL, NULL, NULL, NULL, '2026-01-29 10:18:23'),
(8, NULL, NULL, 6, NULL, NULL, '2026-01-30 07:09:47');
...
(3, 3, 'Taksonomi dan Ontologi', 'Teori', 'Ir. St. Hajrah Mansyur, S.Kom., M.Cs., MTA', 'A1', '308', 6, '2026-01-31', '2026-01-31', 'sekali', '07:30:00', '09:30:00'),
(4, 3, 'Kapita Selekta', 'Teori', 'Muh. Aliyazid Mude, S.Kom., M.Kom.', 'A1', 'R. 409', 7, '2026-01-04', '2026-02-01', 'mingguan', '07:00:00', '09:30:00');
...
(3, 'Halal bi Halal', 'Lab Terpadu', '2026-02-01', '2026-02-01', 7, '07:30:00', '16:30:00', 'sekali', '2026-01-29 07:32:37'),
(4, 'Tes Asisten', 'Lab Startup dan IoT', '2026-02-02', '2026-02-02', 1, '07:30:00', '16:30:00', 'sekali', '2026-01-29 10:18:23');
...
(6, 4, 'Piket Harian', 2, '2025-12-30', '2026-02-03', 'mingguan', '07:00:00', '18:00:00');
...
(2, 2, NULL, 'Admin01', 'Fatimah AR. Tuasamu, S.Kom., MTA, MCF', NULL, NULL, 'Jl. Urip Sumoharjo No.km.5, Panaikang, Kec. Panakkukang, Kota Makassar, Sulawesi Selatan 90231, Indonesia', '08534186497', 'P', 'Laboran', NULL, '1768721611_696c8ccb66f2c.jpeg', 1),
(3, 3, NULL, '13120230033', 'Nurfajri Mukmin Saputra', 'A1', 'Sistem Informasi', 'Kabupaten Bantaeng, Provinsi Sulawesi Selatan', '0853332084', 'L', 'Asisten 2', 'Multimedia', '1768722382_696c8fceac85d.jpeg', 1),
...
(8, 8, 7, '13020230030', 'Muhammad Nur Fuad', 'A1', 'Teknik Informatika', 'Kota Makassar, Provinsi Sulawesi Selatan', '085102827794', 'L', 'Asisten 2', 'AI', '697cb57e44ce3.jpg', 1);
...
(162, 'Pulang', '951a7c03fd3bce8d0a71452e520c536f', '2026-01-30 15:03:37', '2026-01-31 15:03:37'),
(168, 'Presensi', '9a853abbcbaa85ae39a5969c64bd9abf', '2026-01-30 22:34:37', '2026-01-30 22:39:37');
...
(3, '13120230033@student.umi.ac.id', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'User', '2026-01-03 05:23:53'),
(4, '13020230241@student.umi.ac.id', '$2y$12$lFHuRuoExW9RSSBUZm4QgeZMom7v5iLKJfBAtJB68d7qPEOH1gRCm', 'User', '2026-01-27 03:37:51'),
(8, '13020230030@student.umi.ac.id', '$2y$12$W2k33qj0XCk1xNQGcA8dO.QyhSzBQ8z/VIXOQTilVhVosnwK4q7oG', 'User', '2026-01-29 10:31:41');
...
--
-- Dumping data for table `user_google_token`
--

INSERT INTO `user_google_token` (`id_token`, `id_user`, `access_token`, `refresh_token`, `expires_in`, `created_at`) VALUES
(1, 3, 'ya29.a0AUMWg_KU_68ca_zuWaAPBG_cJY99eyUvOwrEDnoS1F_2eQWkr1lHYVhFRRMM5ifhqcabQ1nO5MKQUIOdZ6DcNwZiekEK_P-nqk7qaLlKFjRiMGIbewc4-w0yXsCjwVxgJsUuZJVx0bkAT4Dm2eXVD-yYoHPFF9VSvEXpkoqCkjc0u4fnY6SaFzYTVTS0VSLHLSSWoMUaCgYKAfcSARISFQHGX2MiFpw_5Xw6rwKj_Y-hLuoCyQ0206', '1//0gjTD8ufdx-Y5CgYIARAAGBASNwF-L9IrlE3SBQKOTq2TfD6ibjl0o0m2vQ5GMRTDDf55ejN3-2EnXImQwk22RAj6lCoRvzOn0iM', 3599, '2026-01-29 07:26:39');
...
--
ALTER TABLE `qr_code`
  MODIFY `id_qr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=169;
