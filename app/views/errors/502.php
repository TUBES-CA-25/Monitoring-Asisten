...
<body class="bg-gray-100 h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden text-center p-8 relative border border-gray-200">
        ...
        <div class="mb-6 relative inline-block">
            <div class="absolute inset-0 bg-cyan-50 rounded-full opacity-50"></div>
        ...
        <h1 class="text-3xl font-extrabold text-gray-800 mb-2">502</h1>
        <p class="text-gray-500 mb-8 leading-relaxed text-sm">
            Bad Gateway.<br>
            Server menerima respons yang tidak valid dari server.<br>
        </p>

        <div class="flex flex-col gap-3">
            <button onclick="location.reload()" class="w-full py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-bold rounded-xl