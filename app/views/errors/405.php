...
<body class="bg-gray-100 h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl shadow-2xl overflow-hidden text-center p-8 relative border border-gray-200">
        ...
        <div class="mb-6 relative inline-block">
            <div class="absolute inset-0 bg-orange-50 rounded-full opacity-50"></div>
            <div class="relative bg-orange-50 text-orange-600 w-24 h-24 rounded-full flex items-center justify-center text-4xl shadow-inner border border-orange-100">
        ...
        <div class="flex flex-col gap-3">
            <a href="javascript:history.back()" class="w-full py-3 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl shadow-lg shadow-orange-500/30 transition transform hover:-translate-y-1 flex items-center justify-center gap-2">
