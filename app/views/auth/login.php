...
<body class="h-screen w-screen flex items-center justify-center overflow-hidden font-sans selection:bg-cyan-500 selection:text-white">
    ...
    <div class="bg-container">
        <div class="bg-slide active" style="background-image: url('/Monitoring-Asisten/public/assets/img/startup.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/IoT.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/CV.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/DS.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/Comnet.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/Micro.webp');"></div>
        <div class="bg-slide" style="background-image: url('/Monitoring-Asisten/public/assets/img/Mulmed.webp');"></div>
