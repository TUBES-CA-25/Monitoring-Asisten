            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50">
                    <?php if(!empty($attendance_list)): foreach($attendance_list as $row): 
                        $inTime = $row['waktu_presensi'] ?? $row['check_in_time'] ?? null;
                        $outTime = $row['waktu_pulang'] ?? $row['check_out_time'] ?? null;
                    ...
                    <tr class="hover:bg-indigo-50/30 transition duration-150 group">
                        <td class="p-5 pl-8">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-[10px] text-gray-400 font-mono mt-0.5"><?= $nim ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="p-5">
                        ...
                        <td class="p-5 text-center">
                            <?php 
                                $statusClass = $status == 'Hadir' ? 'bg-green-100 text-green-700 border-green-200' : 'bg-yellow-100 text-yellow-700 border-yellow-200';
                            ?>
