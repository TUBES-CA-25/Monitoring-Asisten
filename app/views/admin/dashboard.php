...
<script>
    ...
    let qrCodeObj = new QRCode(qrcodeContainer, { width: 200, height: 200 });
    let qrInterval = null;
    ...
    function closeQRModal() {
        ...
        // Hentikan interval saat modal ditutup untuk hemat resource
        if (qrInterval) clearInterval(qrInterval);
    }

    function fetchAndRenderQR(type) {
        // Tampilkan loading state jika perlu, atau biarkan update seamless
    ...
    function setQRMode(isEntry) {
        ...
        if (isEntry) {
            ...
            // Set Interval Refresh 1 Menit (60000 ms)
            ...
            // Ambil QR Pulang (Tidak perlu auto-refresh cepat karena valid 24 jam)
